...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("INSERT INTO CaseRegistration (Status,Type1,VName,CName,Complaintname,Mobile,Place,Date1,Time1,assigned) VALUES('" +tstatus+"','" +tcomplainttype+"','"+tvictimname+"','"+tconvictname+"','"+tcomplaintname+"','"+tmobileno+"','"+tplace+"','"+tdate+"','"+ttime + "',0);")
